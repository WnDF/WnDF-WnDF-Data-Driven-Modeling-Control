...
class DoublePendulumnNNModel(torch.nn.Module):
    ...
    def AccuracyFunc(self, y_true, y_pred, treshold = 0.01):
        ...
        for i in range(0,len(y_true)):
            error = torch.abs((y_true[i] - y_pred[i])/y_true[i])
    ...
    def DataPlots(self):
        ...
        fig1ax1.scatter(t_span, Theta1_pred, s=dotsize, label = 'Pred.')
        fig1ax1.scatter(t_span, Theta1, s=dotsize, label = 'True')
        ...
        fig1ax2.scatter(t_span,Theta2_pred, s=dotsize, label = 'Pred.')
        fig1ax2.scatter(t_span, Theta2, s=dotsize, label = 'Pred.')
        ...
        fig2ax1.scatter(t_span, Omega1_pred, s=dotsize, label = 'Pred.')
        fig2ax1.scatter(t_span, Omega1, s=dotsize, label = 'True')
        ...
        fig2ax2.scatter(t_span, Omega2_pred, s=dotsize, label = 'Pred.')
        fig2ax2.scatter(t_span, Omega2, s=dotsize, label = 'True')
        ...
        fig3ax1.scatter(t_span, x1_true, s=dotsize, label = 'True')
        fig3ax1.scatter(t_span, x1_pred, s=dotsize, label = 'Pred.')
        ...
        fig3ax2.scatter(t_span, y1_true, s=dotsize, label = 'True')
        fig3ax2.scatter(t_span, y1_pred, s=dotsize, label = 'Pred.')
        ...
        fig4ax1.scatter(t_span, x2_true, s=dotsize, label = 'True')
        fig4ax1.scatter(t_span, x2_pred, s=dotsize, label = 'Pred.')
        ...
        fig4ax2.scatter(t_span, y2_true, s=dotsize, label = 'True')
        fig4ax2.scatter(t_span, y2_pred, s=dotsize, label = 'Pred.')
        ...
        fig5ax1.plot(epochs, TestLoss, label = 'Test Loss')
        ...
        fig5ax2.plot(epochs, TrainLoss, label = 'Train Loss')
        ...
        fig5ax3.plot(epochs, lr, label = 'Lr')
        ...
        fig6ax1.plot(epochs, Theta1Accuracy, label = 'Acc. Rate (%)')
        ...
        fig6ax2.plot(epochs, Theta2Accuracy, label = 'Accuracy Rate (%)')
        ...
        fig7ax1.plot(epochs, Omega1Accuracy, label = 'Accuracy Rate (%)')
        ...
        fig7ax2.plot(epochs, Omega2Accuracy, label = 'Accuracy Rate (%)')
...
DpNNModel.DataGeneration(t_stop = 10, sim_step_size = 1, dt = 0.0005)
